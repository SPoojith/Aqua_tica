 ...
 * @author Aparna
 */
public class on_air extends javax.swing.JFrame {
...
st.executeQuery("update JR_NEW.ABOVE_WATER set activity_id='"+id+"',name='"+name+"',type='"+type+"',price='"+Price+"',age_group='"+age_group+"',exprience='"+exprience+"',discription='"+Discription+"' where activity_id='"+id+"'");
...
System.out.print(e);            
    ...
    JOptionPane.showMessageDialog(this, "enter id to insert",
                                   "ERROR", JOptionPane.ERROR_MESSAGE);
}else if(Integer.parseInt(j1.getText())<=200 || Integer.parseInt(j1.getText())>299){
...
st.executeQuery("insert into JR_NEW.ABOVE_WATER(activity_id ,name ,type ,price ,age_group ,exprience ,discription) values"
...
public void display(){
    ...
    Statement st;
            ...
            conn = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE", "jr_new", "root");
            st = conn.createStatement();
            rs = st.executeQuery("SELECT * FROM JR_NEW.ABOVE_WATER order by Activity_id ");
            while (rs.next()) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(848, 622, 130, 30));
        ...
        getContentPane().add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 570, -1, -1));
...
Connection conn;
   // ResultSet rs;
    Statement st;
            ...
            st.executeQuery("delete FROM JR_NEW.ABOVE_WATER where Activity_id='"+iid+"'");
