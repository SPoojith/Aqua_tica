 ...
 * @author Aparna
 */
public class on_beach extends javax.swing.JFrame {
...
st.executeQuery("update JR_NEW.ON_BEACH set activity_id='"+id+"',name='"+name+"',type='"+type+"',price='"+Price+"',age_group='"+age_group+"',exprience='"+exprience+"',discription='"+Discription+"' where activity_id='"+id+"'");
...
System.out.print(e);            
    ...
    JOptionPane.showMessageDialog(this, "enter id to insert",
                                   "ERROR", JOptionPane.ERROR_MESSAGE);
}else if(Integer.parseInt(j1.getText())<=100 || Integer.parseInt(j1.getText())>199){
...
st.executeQuery("insert into JR_NEW.ON_BEACH(activity_id ,name ,type ,price ,age_group ,exprience ,discription) values"
...
public void display(){
    ...
    Statement st;
            ...
            conn = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE", "jr_new", "root");
            st = conn.createStatement();
            rs = st.executeQuery("SELECT * FROM JR_NEW.ON_BEACH order by Activity_id");
            while (rs.next()) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 100, 810, 180));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("On_beach");
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 620, 120, 30));
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 570, -1, -1));

        jButton6.setText("delet");
        jButton6.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton6ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 510, 100, 30));
...
public void delete(){
   ...
   // ResultSet rs;
    Statement st;
            ...
            st.executeQuery("delete FROM JR_NEW.ON_BEACH where Activity_id='"+iid+"'");
